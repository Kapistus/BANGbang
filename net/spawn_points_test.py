...
Run from the project root:   python -m net.spawn_points_test
"""
import math
import os
import shutil
...
def authored_map(tmp, spawns, name="spawntest"):
    """A copy of a real map with spawn points written into it."""
...
def main():
    ...
    try:
        ...
        plain = netmaps.spawn_points("demo", maps_dir="maps")
