...
Run from the project root:   python -m net.rejoin_test
"""
import math
import time
...
def main():
    ...
    srv = GameServer(spawns, port=PORT, map_id=MAP, duration_s=600)
    srv.start()
    ...
    try:
        ...
        print(f"match running on {MAP} with 2 players")
